...
3. Run `scripts/kb_tool_audit.py` against the saved trace directory.
4. Check whether:
...
2. Run `run_turn.sh` if you need the full turn timeline.
3. Run `scripts/toolcall_audit.py` against the saved trace directory.
...
3. Run `run_turn.sh` against that directory.
