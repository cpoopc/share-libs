...
IVA_LOGTRACER_ROOT = REPO_ROOT / "apps" / "iva_logtracer"
KIBANA_LIB_ROOT = REPO_ROOT / "tools" / "python" / "libs" / "kibana"

for path in (SCRIPT_DIR, IVA_LOGTRACER_ROOT, KIBANA_LIB_ROOT):
